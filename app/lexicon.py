...
/delete - переводит в режим удаления объектов (для удаления достаточно указать часть ключа);\n\
...
В режиме тренировки для оценки памяти используется шкала:\n\n\
    ...
    2 - некорректный результат, после ознакомления с ответов быстро вспоминается\n\
...
перечня команд (для вывода команд нажмите /help)',
    '/no_training': 'На сегодня нет объектов для тренировки, ты можешь попробовать повторить \
